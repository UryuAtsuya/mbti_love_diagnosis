        ...
        <main className="min-h-screen bg-gradient-to-br from-pink-50 to-yellow-50 py-12 px-4 sm:px-6">
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <div className="p-8 sm:p-12">
                    <Breadcrumb items={[{ label: "記事一覧", href: "/articles" }, { label: "ESFP（エンターテイナー）の性格・恋愛傾向を解説" }]} />
                    ...
                    <div className="prose prose-pink max-w-none text-gray-700">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-gray-800 border-l-8 border-pink-500 pl-4 mb-6">ESFPと相性が取りやすいタイプ</h2>
                            <p className="mb-6 leading-relaxed">
                                ESFPは、今この瞬間を楽しみながら周囲を明るくするタイプです。ESFPの明るさを受け止めてくれながら、生活の安定感を一緒に作れる相手との組み合わせが長続きしやすい傾向があります。
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                                <Link href="/articles/isfj" className="group block bg-gray-50 rounded-xl p-5 border border-gray-100 hover:bg-pink-50 hover:border-pink-200 transition-all">
                                    <h3 className="font-bold text-pink-700 mb-2 group-hover:text-pink-800">ISFJ</h3>
                                    <p className="text-sm text-gray-600">ESFPの明るさとISFJの安定感が自然に補い合う関係です。ISFJがESFPの後ろ盾になりやすく、ESFPがISFJに活気をもたらす形になりやすいです。</p>
                                    <span className="text-xs text-pink-500 font-bold mt-3 inline-block">詳しく読む →</span>
                                </Link>
                                <Link href="/articles/istj" className="group block bg-gray-50 rounded-xl p-5 border border-gray-100 hover:bg-pink-50 hover:border-pink-200 transition-all">
                                    <h3 className="font-bold text-pink-700 mb-2 group-hover:text-pink-800">ISTJ</h3>
                                    <p className="text-sm text-gray-600">ESFPの行動力とISTJの安定感が組み合わさると、生活のバランスが取りやすくなります。互いの違いが長所として機能しやすい組み合わせです。</p>
                                    <span className="text-xs text-pink-500 font-bold mt-3 inline-block">詳しく読む →</span>
                                </Link>
                                <Link href="/articles/esfj" className="group block bg-gray-50 rounded-xl p-5 border border-gray-100 hover:bg-pink-50 hover:border-pink-200 transition-all">
                                    <h3 className="font-bold text-pink-700 mb-2 group-hover:text-pink-800">ESFJ</h3>
                                    <p className="text-sm text-gray-600">社交的で場を明るくする傾向が共通しており、一緒にいて楽しい時間を過ごしやすい関係です。感情を大切にする点も共通しており、理解し合いやすいです。</p>
                                    <span className="text-xs text-pink-500 font-bold mt-3 inline-block">詳しく読む →</span>
                                </Link>
                            </div>
